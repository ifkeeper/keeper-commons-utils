...
public interface ImgRedraw {
	 ...
	 * @param maxWidth 图片最大宽度,如何值为 0,则设置默认值 {@link ImgRedrawImpl#DEFAULT_WIDTH}
	 * @param maxHeight 图片最大高度,如何值为 0,则设置默认值 {@link ImgRedrawImpl#DEFAULT_HEIGHT}
	 * @param quality 图片质量,如0.7f 相当于70%质量,如何值为 0,则设置默认值 {@link ImgRedrawImpl#DEFAULT_QUALITY}
